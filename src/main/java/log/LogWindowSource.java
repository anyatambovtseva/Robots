...
public class LogWindowSource {
    ...
    private final TemporalCircularBuffer<LogEntry> messages;
    private final List<LogChangeListener> listeners = new ArrayList<>();
    private final ReentrantReadWriteLock listenersLock = new ReentrantReadWriteLock();
    private volatile LogChangeListener[] activeListeners;

    public LogWindowSource(int queueLength, TemporalAmount maxLogEntryAge) {
        this.queueLength = queueLength;
        this.messages = new TemporalCircularBuffer<>(queueLength, maxLogEntryAge);
    }
